...
export default function QuemSomos({ slug, ong, settings }) {
    ...
    const fullAboutText =
        settings?.about_text ||
        'Esta instituição ainda não cadastrou sua história detalhada.';

    console.log({ ong, settings });
                ...
                <div className="max-w-3xl mx-auto px-4 py-16">
                    ...
                    <div className="flex flex-col items-center border-t border-gray-100 pt-10">
                        <p className="text-slate-500 mb-6 font-medium">
                            Faça parte desta jornada conosco.
                        </p>
