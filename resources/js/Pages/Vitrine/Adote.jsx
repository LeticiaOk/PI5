...
export default function Adote({ pets = [], slug }) {
    ...
    const heroTitle = settings.hero_title || 'Adote um amigo';
    const heroSubtitle = settings.hero_subtitle || '';
    const ongName = tenant?.name || 'ONG';
    ...
    return (
        <VitrineLayout>
            <div className="min-h-screen bg-gray-50 text-gray-800 antialiased font-sans pb-12">
                ...
                {/* ── FILTROS E BUSCA (Corrigido sem asserções TypeScript) ────────────────── */}
                ...
                {/* ── LISTAGEM DE ANIMAIS (Corrigido para usar pet.id na key) ─────────────────────── */}
