...
export default function Home({ slug, ong, settings, availableCount }) {
    ...
    const heroSubtitle =
        ...
        "Transformando vidas de quatro patas todos os dias.";
            ...
            >
                ...
                <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
                    ...
                    <h1 className="text-4xl md:text-6xl font-black text-white tracking-tight mb-6 drop-shadow-lg">
                        Bem-vindo à{" "}
                        <span style={{ color: primaryColor }}>{ong.name}</span>
                    </h1>
            ...
            <section id="sobre" className="py-24 max-w-7xl mx-auto px-4">
                <div className="flex flex-col md:flex-row items-center gap-16">
                    <div className="flex-1 flex gap-4">
                        <img
                            src={photo1}
                            className="w-1/2 h-80 object-cover rounded-3xl shadow-lg"
                            alt="ONG Photo 1"
                        />
                        <img
                            src={photo2}
                            className="w-1/2 h-80 object-cover rounded-3xl shadow-lg mt-12"
                            alt="ONG Photo 2"
                        />
                    </div>
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-slate-600 leading-relaxed mb-8">
                            {settings?.about_text ||
                                "Descreva aqui a história e os objetivos da sua instituição."}
                        </p>
                        <Link
