...
export default function AdoptionModal({ pet, slug, onClose }) {
    ...
    // Proteção absoluta: Se o pet vier undefined (como no Header), evita que a tela fique branca
    ...
    const submit = (e) => {
        ...
        // Só dispara se houver ID de destino válido
        if (!petId) {
            alert('Erro: Nenhum animal foi selecionado para esta adoção.');
            return;
        }
                ...
                {!isSubmitted ? (
                    ...
                    <>
                        <div className="mb-6">
                            ...
                            <h2 className="text-2xl font-black text-gray-900 tracking-tight">
                                Adotar o(a) <span className="text-[#111827]">{petName}</span>
                            </h2>
                    ...
                    <div className="text-center py-6 animate-scale-up">
                        ...
                        <p className="text-sm text-gray-500 mt-3 max-w-sm mx-auto leading-relaxed">
                            Obrigado pelo interesse em adotar o(a) <strong>{petName}</strong>! Seus dados foram salvos com sucesso e enviados para a ONG.
                        </p>
